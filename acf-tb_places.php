...
class acf_plugin_tb_places {
	...
	*/
	...
	function __construct() {
		...
		load_plugin_textdomain( 'acf-tb_places', false, plugin_basename( dirname( __FILE__ ) ) . '/lang' );
	...
	*/
	...
	function include_field_types( $version = false ) {
		...
		// include
		include_once('fields/acf-tb_places-v' . $version . '.php');
